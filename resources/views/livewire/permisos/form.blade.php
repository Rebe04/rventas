    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" wire:model.lazy="permissionName"
            ...
            <div class="modal-footer">
                ...
                @if ($selected_id < 1) <button wire:click.prevent="createPermission()" type="button"
                    class="btn btn-dark close-modal">
                    GUARDAR</button>

                    @else

                    <button wire:click.prevent="updatePermission()" type="button"
